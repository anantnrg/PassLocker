...
class Edit_Entry(object):
    def setupUi(self, Dialog):
        ...
        str = dl.GetSelectedValue()
        lis = str.split("|||")
        index = self.group.findText(lis[1], QtCore.Qt.MatchFixedString)
        if index >= 0:
            self.group.setCurrentIndex(index)
        self.title.setText(lis[2])
        self.user.setText(lis[3])
        self.password.setText(lis[4])
        self.password2.setText(lis[4])
        self.url.setText(lis[5])
        self.notes.setPlainText(lis[6])
    ...
    def clickMethod(self):
        ...
        if self.password.text() == self.password2.text():
                ...
                pass
                print(psw,' ,' ,base64.b64decode(psw))
                # result = QMessageBox.question('New Entry Saved', "New Entry Saved Successfully", QMessageBox.Yes | QMessageBox.No, QMessageBox.No)
        else:
              #result = QMessageBox.warning('Error', 'Passwords do not match', QMessageBox.Yes | QMessageBox.No, QMessageBox.No)
               pass
